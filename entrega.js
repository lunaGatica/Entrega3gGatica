...
function agruparuUsuarios(usuariosBotanica) {
    const Usuario = [];
    usuariosBotanica.forEach(usuariosBotanica => {
        if (Usuario[usuariosBotanica]) {
            Usuario[usuariosBotanica].push(usuariosBotanica);
        } else {
            Usuario[usuariosBotanica] = [usuariosBotanica];
        }
    });
...
const Usuarios = Object.values(Usuario);
    return Usuarios;
